...
- Multiple choice: use exactly 4 options per question. Wrong options must be plausible — drawn from the actual chapter context — not obviously wrong or absurd. Never make wrong answers trivially dismissible.
...
- Questions must not contain phrasing that gives away the answer
